...
Feature:Levy standard learner, price is changed, originally mix funded and a negative amount is left to be paid - results in a refund PV2-256
	...
	And the following commitments exist
		| Apprenticeship   | start date                   | end date                     | agreed price | status | Standard Code | Programme Type |
		| Apprenticeship 1 | 01/Aug/Current Academic Year | 31/Jul/Current Academic Year | 11250        | active | 25            | 25             |
    ...
    But  the Commitment details are changed as follows
		| Apprenticeship   | commitment Id | status | version Id | priority | start date                   | end date                     | agreed price | standard code | programme type |
		| Apprenticeship 1 | 1             | active | 2          | 1        | 01/Aug/Current Academic Year | 31/Jul/Current Academic Year | 1400         | 25            | 25             |

    But the Provider now changes the Learner details as follows
		| Start Date                   | Planned Duration | Total Training Price | Total Training Price Effective Date | Completion Status | SFA Contribution Percentage | Contract Type | Aim Sequence Number | Aim Reference | Standard Code | Programme Type | Funding Line Type                                  |
		| 01/Aug/Current Academic Year | 12 months        | 1400                 | 01/Aug/Current Academic Year        | continuing        | 90%                         | Act1          | 1                   | ZPROG001      | 25            | 25             | 16-18 Apprenticeship (From May 2017) Levy Contract |

	And price details as follows
        | Price details     | Total Training Price | Total Training Price Effective Date | Total Assesment Price | Total Assesment Price Effective Date | SFA Contribution Percentage | Contract Type |
        | 1st price details | 9000                 | Aug/Current Academic Year           | 2250                  | Aug/Current Academic Year            | 90%                         | Act1          |
        | 2nd price details | 1200                 | Oct/Current Academic Year           | 200                   | Oct/Current Academic Year            | 90%                         | Act1          |
